...
class _HomePageState extends State<HomePage>  with WidgetsBindingObserver, AutomaticKeepAliveClientMixin{
  ...
  //       decoration: InputDecoration(
  //         border: InputBorder.none,
  //         hintText: "Select Location", // Add a hint text
  ...
  //           selectedItem = newValue!;
  //         });
  //         print("Selected Location: $selectedItem");
  //       },
  ...
  //       style: TextStyle(color: Colors.black, fontSize: 16),
  //       dropdownColor: Colors.white,
  //       // Optional: Add a custom item builder for better styling
  //       itemHeight: 50, // Set item height for better touch targets
  //     ),
  //   );
  // }
}

/// "${DateTime.now().toLocal().day}-${DateTime.now().toLocal().month}-${DateTime.now().toLocal().year}".split(' ')[0], // Date
///
///
/// share bottom sheet function
...
//           children: [
//             Text("Share this app", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
//             SizedBox(height: 10),
//             ElevatedButton.icon(
//               onPressed: () {
//                 print('Clicked Share');
