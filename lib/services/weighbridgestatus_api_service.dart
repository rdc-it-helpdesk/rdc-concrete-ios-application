...
class WeighbridgestatusApiService {
  final Dio _dio;

  WeighbridgestatusApiService() : _dio = ApiClient.getDio();

  Future<SetStatus> weighbridgestatus(String loction) async {
    try {
      final response = await _dio.post(
        'weighbridgestatus.php',
