...
class DriverServicecheck {
  final Dio _dio;

  DriverServicecheck() : _dio = ApiClient.getDio();
  Future<SetStatus> checkDriverStatus(String selectedUserId) async {
    try {
      final response = await _dio.post(
        "drivercheck.php",
        data: {'d_id': selectedUserId},
