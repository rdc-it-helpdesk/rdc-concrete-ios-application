...
class UpdatevehicleApiService {
  final Dio _dio;

  UpdatevehicleApiService() : _dio = ApiClient.getDio();

  Future<SetStatus> updatevehicle(
    String vehicleno,
    String rfifno,
    String rfid,
  ) async {
    try {
      ...
      //print("vehicleno ${vehicleno} rfifno ${rfifno} RFID ${RFID}");
